...
void makeTextures2()
{
    glGenTextures(2, texture2); // Gera 4 nomes de textura e salva no vetor texture
    ...
    glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_NEAREST);
    glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB, FACEBLACK_WIDTH, FACEBLACK_HEIGHT, 0, GL_RGB, GL_UNSIGNED_BYTE, FACEBLACK);
}
